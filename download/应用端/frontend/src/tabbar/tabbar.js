...
export const dynamicTabBars = [
  { url: '/pagesA/chat/index',   text: 'home',    icon: chatIcon,    onicon: chatIconActive,    title: 'Social'    },
  ...
  { url: '/pagesA/service/index',text: 'service', icon: serviceIcon, onicon: serviceIconActive, title: 'Health' }
]
