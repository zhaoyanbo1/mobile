...
import com.kuafu.web.mapper.EmergencyContactAllMapper;
 ...
 */
@Slf4j
@Service("EmergencyContactAll")
public class EmergencyContactAllServiceImpl extends ServiceImpl<EmergencyContactAllMapper, EmergencyContactAll> implements IEmergencyContactAllService {
@Autowired
private EmergencyContactAllMapper taskInfoAllMapper;


@Override
public List<EmergencyContactAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<EmergencyContactAll> queryWrapper) {

        LambdaQueryWrapper<EmergencyContactAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<EmergencyContactAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<EmergencyContactAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<EmergencyContactAll> queryWrapper) {
        LambdaQueryWrapper<EmergencyContactAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<EmergencyContactAll> page, PageRequest pageRequest, LambdaQueryWrapper<EmergencyContactAll> queryWrapper) {
