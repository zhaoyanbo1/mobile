...
public class HealthQuestionnaireControllerService {
    ...
    return HealthQuestionnaire.builder()
            .healthQuestionnaireId(vo.getHealthQuestionnaireId())
            .userInfoUserInfoId1(vo.getUserInfoUserInfoId1())
            .adl(vo.getAdl())
            .mobilityOut(vo.getMobilityOut())
            .falls(vo.getFalls())
            .weightLoss(vo.getWeightLoss())
            .diseases(vo.getDiseases())
            .paMinutes(vo.getPaMinutes())
            .paWillingness(vo.getPaWillingness())
            .fluVaccine(vo.getFluVaccine())
            .polypharmacy(vo.getPolypharmacy())
            .social(vo.getSocial())
            .fvServes(vo.getFvServes())
            .totalScore(vo.getTotalScore())
            .riskLevel(vo.getRiskLevel())
            .answersJson(vo.getAnswersJson())
