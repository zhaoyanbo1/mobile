...
public class HealthQuestionnaireAllController  {
    ...
    public BaseResponse page(@RequestBody HealthQuestionnaireAllPageVO pageVO){
        ...
        if(StringUtils.isNotEmpty(pageVO.getDiseases())) {
            queryWrapper.eq(HealthQuestionnaireAll::getDiseases, pageVO.getDiseases());
        }
        ...
        if(StringUtils.isNotEmpty(pageVO.getRiskLevel())) {
            queryWrapper.eq(HealthQuestionnaireAll::getRiskLevel, pageVO.getRiskLevel());
        }
        if(StringUtils.isNotEmpty(pageVO.getAnswersJson())) {
            queryWrapper.eq(HealthQuestionnaireAll::getAnswersJson, pageVO.getAnswersJson());
        }
