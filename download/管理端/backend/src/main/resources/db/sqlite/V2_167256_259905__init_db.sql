...
insert into `static_resources` (`resource_path`, `related_table_name`, `related_table_key`, `relate_table_column_name`) values ('https://www..net/preview/medicine_photo.jpg','reminder_item', '1', 'medicine_photo');
...
insert into `static_resources` (`resource_path`, `related_table_name`, `related_table_key`, `relate_table_column_name`) values ('https://www..net/preview/medicine_photo.jpg','reminder_item', '4', 'medicine_photo');
insert into `reminder_item` (`user_info_user_info_id_1`, `reminder_type_enum_id`, `title`, `description`, `reminder_time`, `is_completed`, `medicine_photo_resource_key`, `medicine_dosage`, `location_latitude`, `location_longitude`, `location_address`, `diet_recipe_id`, `creation_time`, `update_time` ) values ("5","1","早晨服用心脏药","服用阿司匹林1片","2025-01-01 00:00:00","True","0","1片","","","","","2025-01-01 00:00:00","2025-01-01 00:00:00" );
insert into `static_resources` (`resource_path`, `related_table_name`, `related_table_key`, `relate_table_column_name`) values ('https://www..net/preview/medicine_photo.jpg','reminder_item', '5', 'medicine_photo');
